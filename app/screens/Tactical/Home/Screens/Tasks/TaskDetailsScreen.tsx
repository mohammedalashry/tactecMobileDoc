...
import { useTacticalTaskDetail } from "hooks/tactical/tasks/useTacticalTaskDetail";
...
const TaskDetailsScreen = ({ route, navigation }) => {
  const {
    ...
    handleAssign,
    isUpdateLoading,
  } = useTacticalTaskDetail(route, navigation);
    ...
    >
        ...
        {task && (
          <>
            ...
            <Alert
              ...
              title={I18n.t("tasks.taskSent")}
              message={I18n.t("tasks.taskSentMessage")}
      ...
      {!isEditing && canEdit && (
        <TouchableOpacity style={styles.assignButton} onPress={handleAssign}>
          ...
          <Text style={styles.assignText}>{I18n.t("tasks.assignTo")}</Text>
        </TouchableOpacity>
      )}
    </DetailScreen>
  );
