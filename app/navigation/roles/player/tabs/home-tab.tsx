// roles/player/tabs/home-tab.tsx
import {createTopTabs} from '../../../common/factories/create-top-tabs';
import {TabIcons} from '../../../common/icons/tab-icons';
import {translate} from '@app/i18n';
// Import screens
import MatchesScreen from 'screens/Player/Home/Screens/Matches/MatchesScreen';
import TasksScreen from 'screens/Player/Home/Screens/Tasks/TasksScreen';
import TrainingsScreen from 'screens/Player/Home/Screens/Traning/TrainingsScreen';
import {CalendarScreen} from 'screens/Player/Home/HomeScreens';
...
const homeTabScreens = [
  ...
  },
  {
    ...
    icon: ({color}) => TabIcons.calendar({color}),
  },
  {
    name: 'TasksScreen',
